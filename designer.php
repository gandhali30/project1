...
?>
	<tr>
		...
		<td style="text-align: center;" ><a href="designer_edit.php?no=<?php echo $row["PROJECT NO"];?>" style="color:red;text-decoration: underline;"><?php echo $row["PROJECT NO"];?></a></td>
