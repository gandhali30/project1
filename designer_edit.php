...
?>
      ...
      <h1 align="center">Welcome <?php echo $user_id; ?></h1> 
       <h2 style="margin-right: 80%"><a href = "designer.php">Back</a></h2>
...
$sql="select project_id 'PROJECT NO',user_id 'USER_ID',ARTWORK_NAME 'ARTWORK NAME', SELECT_TYPE 'TYPE',DIVISION_TYPE 'DIVISION',STATUS 'STATUS',Date_Time 'TIME',ATTACHMENT,CMD_REMARK,VP_REMARK,DESIGNER_REMARK,DESIGNER_ATTACH,REMARK,MARKETING_REMARK,SCM_REMARK from project_master where PROJECT_ID=$PROJECT_ID";
...
{
?>
<tr><th style='text-align:left'>DESIGNER REMARK</th><td style='text-align:LEFT'>  
				<textarea name="DESIGNER_REMARK"  style="width:100%" ><?php echo $row["DESIGNER_REMARK"];?></textarea></td></tr>

<tr><th style='text-align:left;'>ATTACH A FILE: </th><td style='text-align:left;'><a href="<?php echo $row["DESIGNER_ATTACH"];?>"><?php echo $row["DESIGNER_ATTACH"];?></a><input type='file' name='MYFILE' multiple></td></tr>

<tr><th colspan="2" style='text-align:LEFT'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="UPLOAD" >UPLOAD</button></th></tr>	
<?php
}
?>
<?php
			...
			$DESIGNER_REMARK = $_POST['DESIGNER_REMARK'];			
			$sql_query="update project_master set STATUS=8, DESIGNER_REMARK='$DESIGNER_REMARK',DESIGNER_ATTACH='$target' where PROJECT_ID=$PROJECT_ID";
