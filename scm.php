...
<tr>
	...
	<td style="text-align: center;" bgcolor="green"><b>SCM REMARK</b></td>
...
?>
	<tr>
		...
		<td style="text-align: center;" ><a href="scm_edit.php?no=<?php echo $row["PROJECT NO"];?>" style="color:red;text-decoration: underline;"><?php echo $row["PROJECT NO"];?></a></td>
