...
<tr>
	...
	<td style="text-align: center;" bgcolor="green"><b>REMARK</b></td>
...
?>
	<tr>
		...
		<td style="text-align: center;" ><a href="cmd_edit.php?no=<?php echo $row["PROJECT NO"];?>" style="color:red;text-decoration: underline;"><?php echo $row["PROJECT NO"];?></a></td>
