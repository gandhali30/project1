...
?>
      ...
      <h1 align="center">Welcome <?php echo $user_id; ?></h1> 
       <h2 style="margin-right: 80%"><a href = "vp.php">Back</a></h2>
...
<?php
if($row[STATUS]!=6 && $row[STATUS]!=3 && $row[STATUS]!=1 && $row[STATUS]!=2)
{
?>	
...
<?php
if($row[STATUS]==6 or $row[STATUS]==3 or $row[STATUS]==1 or $row[STATUS]==2)
{
?>
<tr><th style='text-align:left;'>REMARK </th><td style='text-align:left;' ><?php echo $row["REMARK"];?></td></tr>
<tr><th style='text-align:left;'> CMD REMARK </th><td style='text-align:left;' ><?php echo $row["CMD_REMARK"];?></td></tr>
<tr><th style='text-align:left;'>ATTACHMENT</th><td style='text-align:left;'><a href="<?php echo $row["ATTACHMENT"];?>"><?php echo $row["ATTACHMENT"];?></a></td></tr>
<tr><th style='text-align:left'>VP REMARK</th><td style='text-align:LEFT'>  
				<textarea name="VP_REMARK"  style="width:100%" ><?php echo $row['VP_REMARK'];?></textarea></td></tr>
...
<?php
			...
			{	
			$VP_REMARK = $_POST['VP_REMARK'];			
			$sql_query="update project_master set STATUS=2, VP_REMARK='$VP_REMARK' where PROJECT_ID=$PROJECT_ID";
...
<?php
			...
			{	
			$VP_REMARK = $_POST['VP_REMARK'];			
			$sql_query="update project_master set STATUS=1,VP_REMARK='$VP_REMARK' where PROJECT_ID=$PROJECT_ID";
